...
/* ===================== BOTÕES — OPÇÃO A (elegante e institucional) ===================== */
.stButton > button {
  font-family: 'Ofelia Display', sans-serif !important;
  font-weight: 500 !important;         /* Medium (manual-friendly) */
  ...
  border: 1px solid rgba(5,43,56,0.70) !important;  /* mais leve */
  border-radius: 12px !important;

  box-shadow: 0 8px 18px rgba(0,0,0,.12) !important; /* mais “premium” */
